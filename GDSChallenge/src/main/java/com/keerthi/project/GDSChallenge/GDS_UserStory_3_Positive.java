...
public class GDS_UserStory_3_Positive {
	WebDriver driver;
	...
	public void Declareackterms() throws InterruptedException {
		...
		WebDriverWait companyprofileconsentack = new WebDriverWait(driver, 10);
		companyprofileconsentack
				.until(ExpectedConditions.elementToBeClickable(By.id("react-declaration-info_truthfulness_check")))
				.click();

		driver.findElement(By.id("submit-btn")).click();

		String applicationresult = companyprofileconsentack
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//section[@class='card']"))).getText();
		System.out.println(applicationresult);

		WebDriverWait Mygrants = new WebDriverWait(driver, 10);
		Mygrants.until(ExpectedConditions.elementToBeClickable(By.linkText("My Grants"))).click();

		WebDriverWait Mygrantsapp = new WebDriverWait(driver, 10);
		Mygrantsapp.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//div[@id='js-app']/div/div[2]/div/div/div/div[2]/section[1]/ul/li[1]/a"))).click();

		WebDriverWait Processing = new WebDriverWait(driver, 10);
		Processing.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='grants']/div[3]/section[1]/ul/li[3]/a")))
				.click();

		String processingappln = companyprofileconsentack.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//table[@id='db-apps-processing']//tbody[@class='tab-content']//tr[1]"))).getText();
		System.out.println(processingappln);

		System.out.println("Submitted Details are under processing tab");
